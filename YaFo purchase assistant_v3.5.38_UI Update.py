...
class PurchaseOrderGenerator:
    def __init__(self, root):
        self.root = root
        self.root.title("YaFo兼容采购助理 v3.5.38")
    ...
    def setup_ui(self):
        ...
        def make_card(parent, title, **kwargs):
            ...
            accent = tk.Frame(header, bg=self.primary, width=4, height=18)
        ...
        def make_btn(parent, text, command, bg="#e2e8f0", fg="#0f172a", width=None, height=None, font_size=10, bold=False, hover_bg=None):
        ...
        # 顶部标题区
        header_frame = tk.Frame(self.root, bg=self.primary_dark, height=96)
        ...
        make_btn(header_frame, "维护日志", self.show_changelog, bg="#2563eb", fg="white", width=10, hover_bg="#3b82f6").pack(side="right", padx=24, pady=22)
        ...
        make_btn(btn_row, "选择文件（支持多选）", self.select_multiple_files, bg=self.primary, fg="white", width=20, bold=True, hover_bg="#2563eb").pack(side="left", padx=(0, 8))
        make_btn(btn_row, "清空列表", self.clear_file_list, bg="#e2e8f0", fg=self.text_color, width=12, hover_bg="#cbd5e1").pack(side="left", padx=4)
        make_btn(btn_row, "移除选中", self.remove_selected_file, bg=self.danger_soft, fg="#991b1b", width=12, hover_bg="#fecaca").pack(side="left", padx=4)
        ...
        make_btn(warehouse_btn_frame, "选择分仓文件（支持多选）", self.select_warehouse_files, bg=self.primary, fg="white", width=24, bold=True, hover_bg="#2563eb").pack(side="left", padx=(0, 8))
        make_btn(warehouse_btn_frame, "清空", self.clear_warehouse_files, bg="#e2e8f0", fg=self.text_color, width=8, hover_bg="#cbd5e1").pack(side="left", padx=4)
        ...
        tk.Entry(row1, textvariable=self.product_file, font=("微软雅黑", 9), width=62, relief="flat", bd=0, bg=self.card_soft, fg=self.text_color, highlightthickness=1, highlightbackground=self.border, highlightcolor=self.primary).pack(side="left", padx=6, ipady=5)
        ...
        make_btn(row1, "CSV导入", self.export_nc_csv_to_excel, bg="#7c3aed", fg="white", width=8, bold=True, hover_bg="#6d28d9").pack(side="left", padx=2)
        ...
        tk.Entry(row2, textvariable=self.output_dir, font=("微软雅黑", 9), width=62, relief="flat", bd=0, bg=self.card_soft, fg=self.text_color, highlightthickness=1, highlightbackground=self.border, highlightcolor=self.primary).pack(side="left", padx=6, ipady=5)
        ...
        self.run_btn = make_btn(btn_frame, "生成XML和汇总表", self.run_process, bg=self.success, fg="white", width=20, height=2, font_size=12, bold=True, hover_bg=self.success_dark)
        self.run_btn.pack(side="left", padx=(0, 10))
        make_btn(btn_frame, "清空", self.clear_all_files, bg="#e2e8f0", fg=self.text_color, width=10, height=2, hover_bg="#cbd5e1").pack(side="left", padx=6)
